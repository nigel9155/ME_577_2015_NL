...
void GLSphereSpot::initShader(void)
{
    ...
    _light_source1._lightPos = glm::vec4(15.0,15.0,5.0, 1.0);
    ...
    _light_source1._cone_angle = 10.0; // in degree
    ...
    // define the position of the light and send the light position to your shader program
    _light_source2._lightPos = glm::vec4(20,20,0.0, 1.0);
    ...
    _light_source2._cone_angle = 5.0; // in degree
    _light_source2._cone_direction = glm::vec3(-1.0, -1.0, 0.0); // this must be aligned with the object and light position.
    
    // Read all the index values from the shader program
    _light_source2._ambientIdx = glGetUniformLocation(_program, "ambient_intensity");
    _light_source2._diffuseIdx = glGetUniformLocation(_program, "diffuse_intensity");
    _light_source2._specularIdx = glGetUniformLocation(_program, "specular_intensity");
    _light_source2._attenuation_coeffIdx = glGetUniformLocation(_program, "attenuationCoefficient");
    _light_source2._lightPosIdx = glGetUniformLocation(_program, "light_position");
    _light_source2._cone_angleIdx = glGetUniformLocation(_program, "cone_angle");
    _light_source2._cone_directionIdx = glGetUniformLocation(_program, "cone_direction");
    ...
    // Send the light information to your shader program
    glUniform1i(_light_source2._ambientIdx, _light_source2._ambient_intensity );
