...
"    vec4 transformedNormal1 =  normalize(transpose(inverse(modelMatrixBox1)) * vec4( normal1, 1.0 ));             \n"
"    vec4 surfacePostion1 = modelMatrixBox1 * vec4(in_Position, 1.0);                             \n"
"                                                                                                               \n"
...
"    vec3 cameraPosition1 = vec3( -viewMatrixBox1[3][0], -viewMatrixBox1[3][1], -viewMatrixBox1[3][2]);             \n"
...
void GLSphere::initShader(void)
{
    ...
    _light_source0._lightPos = glm::vec4(10.0,10.0,10.0,1.0);
    _light_source0._ambient_intensity = 0.3;
    _light_source0._specular_intensity = 0.5;
    _light_source0._diffuse_intensity = 2.0;
...
//    glUniform4fv(_light_source0._lightPosIdx, 1, &_light_source0._lightPos[0]);
    ...
    //define the position of the light and send the light position to your shader program
    _light_source1._lightPos = glm::vec4(20.0,20.0,15.0,0.0);
    ...
    _light_source1._cone_angle = 1.0; // in degree
