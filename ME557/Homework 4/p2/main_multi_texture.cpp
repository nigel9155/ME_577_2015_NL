...
// %Nigel Lee, Chloe McPherson and Anupa Prudhivi
//
...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../../data/shaders/multi_texture_p2.vs", "../../data/shaders/multi_texture_p2.fs");
    ...
    //int texid = texture->loadAndCreateTextures("../../data/textures/Rafael-landscape_NRM_crazybump.bmp","../../data/textures/Rafael-landscape.bmp");
    //int texid = texture->loadAndCreateTextures("../../data/textures/Landscape.bmp", "../../data/textures/texture_sun_512_512.bmp");
    int texid = texture->loadAndCreateTextures("../../data/textures/Landscape.bmp", "../../data/textures/texture_sun_512_noise2.bmp");
    //int texid = texture->loadAndCreateTextures("../../data/textures/texture_earth_128x128_a.bmp");
