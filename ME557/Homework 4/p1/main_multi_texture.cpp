...
// Nigel Lee, Anupa Prudhivi, Chloe McPherson
//
...
int main(int argc, const char * argv[])
{
    ...
    int texid = texture->loadAndCreateTextures("../../data/textures/texture_brick.bmp", "../../data/textures/texture_sun_512_512.bmp", "../../data/textures/texture_isu.bmp");
    //int texid = texture->loadAndCreateTextures("../../data/textures/hamster1.bmp", "../../data/textures/hamster2.bmp", "../../data/textures/hamster.bmp");
