...
void main(void)                                                   
{
    ...
    vec4 tex_idk = texture(texture_test, pass_TexCoord);
    ...
    if(texture_blend == 0)
    {
        color = 0.1 * pass_Color + tex_color + tex_color_light + tex_idk;
    }
    else if(texture_blend == 1)
    {
        color = tex_color * tex_color_light + 0.4*tex_idk;
    }
    else if(texture_blend == 2)
    {
        color = (tex_color_light.r)*tex_color * 0.7 + tex_idk ;
    }
    else
    {
        color = 0.1 * pass_Color + tex_color + tex_idk;
    }
