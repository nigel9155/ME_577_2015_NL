...
string  GLMultiTexture::_glsl_names[4] = { "texture_background", "texture_foreground", "texture_blend", "texture_test"};
#endif
...
bool GLMultiTexture::addVariablesToProgram(GLuint program, int variable_index)
{
    ...
    _textureIdx3 = glGetUniformLocation(program, _glsl_names[3].c_str() );
    checkUniform(_textureIdx3, _glsl_names[3]);
...
//    string newstring1 = name.substr(idx+2, name.length() - 3);
//    
//    ifstream f3(newstring1.c_str());
//    if (f3.good()) {
//        f3.close();
//        exits = true;
//    } else {
